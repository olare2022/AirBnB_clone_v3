																																																																							                ...
																																																																							                * `list_users` - retrieves list of of User objects
																																																																									          * `create_user` - creates a User
																																																																										            * `get_user` - retrieves a User object
																																																																														...
																																																																														```
																																																																														HBNB_ENV: running environment. It can   for the  soon!)
																																																																														HBNB_MYSQL_USER: the username of your MySQL
																																																																														HBNB_MYSQL_PWD: the password of your MySQL
																																																																														HBNB_MYSQL_HOST: the hostname of your MySQL
																																																																														HBNB_MYSQL_DB: the database name of your MySQL
																																																																														HBNB_TYPE_STORAGE: the type of storage used. It can  (using FileStorage) or db (using DBStorage)
																																																																														```
																																																																																																												      ...
																																																																																																												      * HTTP 1.0, assume close after body
																																																																																																													  ...
																																																																																																													  "created_at": "2017-03-25T02:17:06",
																																																																																																													    "id": "1da255c0-f023-4779-8134-2b1b40f87683",
																																																																																																														  ...
																																																																																																														  **hbnb** is open source and free to download and usefilebe productionmoment (testor devbe 
=======
## Environment
